      ...
      <section id="certificates" className="max-w-5xl mx-auto py-24 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <CertificateCard 
            ...
            issuer="Huawei"
            date="2025"
            desc="Expertise in Artificial Intelligence foundations and Huawei AI solutions."
          />
          <CertificateCard 
            title="HCIA-openGauss V1.0"
            issuer="Huawei"
            date="2025"
            desc="Deep understanding of openGauss database architecture and management."
          />
          <CertificateCard 
            title="Intermediate Python"
            issuer="Sololearn"
            date="2025"
            desc="Validated proficiency in Python programming and data structures."
          />
        </div>
      </section>
